# Guide in Poland
Guide in Poland terminal based web application, its same as regular website but implemented with Python,
therefore it run in the terminal rather than browser
